                        ...
                        <div class="card bg-authentication mb-0">
                            <div class="row m-0">
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                ...
                                                @endphp
                                                <h4 class="text-center mb-2">Welcome to <br> {{ $settings->config_value}}</h4>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="form-group mb-50">
                                                    ...
                                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" placeholder="Email address">
                                                    @error('email')
                                ...
                                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                    <img class="img-fluid" src="{{ asset('assets/backend')}}/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                            </div>
                        </div>
                    </div>
