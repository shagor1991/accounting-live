        ...
        <div class="content-body">
            <section id="widgets-Statistics">
                <div class="container">
                    ...
                    <div class="row pt-3">
                        <div class="col-md-1">
                            <img src="{{ asset('assets/backend/app-assets/settings/'.$logo->config_value)}}"  style="height: 100px" alt="Company Logo">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                   <div class="row">
                    ...
                    <div class="col-12">
                        <h3>
                            <span style="border-top: 2px solid black">RECEIPT VOUCHER</span>
                        </h3>
                    </div>
                   </div>
                ...
                <div class="col-md-4 ">
                    ...
                    <h3 class="ml-5">
                        Date: <span style="width:100px;border-bottom: 1px dotted black" class="text-center">{{ $receipt_voucher->payment_date}}</span>
                    </h3>
                    ...
                    <section id="widgets-Statistics">
                        <div class="row pt-4">
                            ...
                            <div class="col-md-8 text-left mb-1" style="border-bottom: 2px dotted black">
                                <span class="text-dark">{{$receipt_voucher->party->pi_name}}</span>
                            </div>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-3 grid-container2">
                                ...
                                <div style="border-bottom: 2px dotted black" class="text-center">
                                    <span class="text-dark">{{ $receipt_voucher->payment_date}}</span>
                                </div>
                                <div>
                                    <span><small>Arabic Font</small></span>
                                </div>
