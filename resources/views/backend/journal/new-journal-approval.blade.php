    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route("journal-approval-section")}}" class="nav-item nav-link active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
            ...
            <div class="tab-content bg-white">
                <div id="journalAuthorization" class="tab-pane active">
                    <section id="widgets-Statistics">
                        <div class="col-md-12">
                            <div class="row">
                                <h4 class="mt-2 ml-2">Journal to Approval</h4>
                            </div>
                        </div>
                    </section>
                    <section>
                                        ...
                                        <tr class="trFontSize">
                                            ...
                                            <td style="padding-bottom: 11px; padding-top: 0px">
                                                <div class="d-flex justify-content-end">
                                                    <a href="#" class="btn journalApprovalShowId" style="height: 30px; width: 30px;" title="Preview" id="{{$journal->id}}">
