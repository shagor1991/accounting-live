                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                <input type="text" id="branch" class="form-control"
                                                                    ...
                                                                    placeholder="Branch Name" disabled readonly>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 form-group ">
                                                                    <input type="number" id="ac_no" class="form-control"
                                                                        ...
                                                                        placeholder="Account Number" disabled readonly>
                                                                        @error('ac_no')
                                                            ...
                                                            <div class="col-md-8 form-group">
                                                                    <input type="text" id="signatory" class="form-control"
                                                                        ...
                                                                        placeholder="Authorized Signatory" disabled readonly>
                                                            ...
                                                            <div class="col-12 d-flex justify-content-end ">
                                                                ...
                                                                <button type="submit" class="btn btn-primary mr-1" disabled>Submit</button>
                                                                <button type="reset" class="btn btn-light-secondary" disabled>Reset</button>
