                            ...
                            <div class="card-body pt-0 pb-0">
                                <table class="table table-sm">
                                    ...
                                    @php
                                        ...
                                        $total_credit=0;
                                    @endphp
                                    @foreach (App\JournalRecord::where('journal_date', $date)->distinct()->get('master_account_id') as $unique_master_ac)
                                    ...
                                    <tr>                                
                                        ...
                                        @php
                                            ...
                                            $each_ledger_cr=0;
                                        @endphp
                                        @foreach (App\JournalRecord::where('master_account_id', $unique_master_ac->master_account_id )->distinct()->where('journal_date', $date)->get('account_head_id') as $account_head_id)
                                            
                                            @php
                                                $single_dr=0;
                                                $single_cr=0;
                                            @endphp
                                            @foreach (App\JournalRecord::where('account_head_id', $account_head_id->account_head_id)->where('journal_date', $date)->get() as $single_jl_entry)
