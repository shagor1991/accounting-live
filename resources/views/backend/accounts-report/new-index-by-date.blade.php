                        ...
                        <section id="widgets-Statistics">
                            <div class="cardStyleChange">
                                <div class="card-header d-flex">
                                    <h4 class="card-title flex-grow-1">General Ledger {{ $date }}</h4>
                                    <div>
                                ...
                                <div class="card-body pt-0 pb-0">
                                    <table class="table table-sm">
                                        @foreach (App\JournalRecord::where('journal_date', $date)->distinct()->get('account_head_id') as $unique_acc_head)
                                        <tr>                                
                                        ...
                                        <tr>                                
                                            ...
                                            @php
                                                ...
                                                $each_ledger_cr=0;
                                            @endphp
                                            @foreach (App\JournalRecord::where('account_head_id', $unique_acc_head->account_head_id )->where('journal_date', $date)->get() as $record)
                                                
                                                @php
                                                    $reverse= $record->transaction_type== "DR" ? "CR" : "DR";   
                                                @endphp
                                                @foreach (App\JournalRecord::where('journal_id',$record->journal_id)->where('transaction_type', $reverse)->where('journal_date', $date)->get() as $ledger_record)
                                                <tr class="trFontSize">
