    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route("new-accounts-receivable-ledger")}}" class="nav-item nav-link tabPadding active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                ...
                <div class="tab-pane active">
                    <div class="content-body">
                        ...
                        <section id="widgets-Statistics">
                            <div class="cardStyleChage">
                                <div class="card-header d-flex pb-0 pr-3">
                                    <h4 class="card-title flex-grow-1">Accounts Receivable Ledger
                                        @php
                                            if(isset($date)){
                                                echo $date;
                                ...
                                <div class="card-body d-flex justify-content-end  pt-0 pb-0">
                                    <div class="col-md-5 text-right pl-2">
                                ...
                                <table   class="table table-sm">
                                    ...
                                    <tr>                                
                                        ...
                                        @php
                                            ...
                                            $each_ledger_cr=0;
                                            if(isset($date)){
                                                $records= App\JournalRecord::where('journal_date',$date)->where('account_head_id', $ac_payable_id )->get();
                                            }elseif(isset($from) && isset($to)){
                                                $records= App\JournalRecord::whereBetween('journal_date',[$from,$to])->where('account_head_id', $ac_payable_id )->get();
                                            }else{
                                                $records= App\JournalRecord::where('account_head_id', $ac_payable_id )->get();
                                            }
                                        @endphp
                                        @foreach ($records as $record)
                                            ...
                                            @php
                                                ...
                                                if(isset($date)){
                                                    $ledger_records= App\JournalRecord::where('journal_date',$date)->where('journal_id',$record->journal_id)->where('transaction_type', $reverse)->get();
                                                    
                                                }elseif(isset($from) && isset($to)){
                                                    $ledger_records= App\JournalRecord::whereBetween('journal_date',[$from,$to])->where('journal_id',$record->journal_id)->where('transaction_type', $reverse)->get();
                                                    
                                                }else{
                                                    $ledger_records= App\JournalRecord::where('journal_id',$record->journal_id)->where('transaction_type', $reverse)->get();
