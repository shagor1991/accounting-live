                    ...
                    <div class="content-body">
                        <section id="widgets-Statistics">
                            <div class="cardStyleChange">
                                ...
                                <div class="card-body d-flex justify-content-end  pt-0 pb-0 mt-0">
                                    ...
                                    <div class="col-md-7">
                                        <form action="{{ route('new-trial-balance-date-range') }}" method="GET" class="d-flex">
                                            <div class="row">
                                                <div class="col-5 ">
                            ...
                            <div class="card-body pt-0 pb-0">
                                <table  class="table table-sm table-hover">
                                    ...
                                    @php
                                        ...
                                        $total_credit=0;
                                    @endphp
                                    @foreach (App\JournalRecordsTemp::distinct()->get('master_account_id') as $unique_master_ac)
                                    ...
                                    <tr>                                
                                        ...
                                        @php
                                            ...
                                            $each_ledger_cr=0;
                                        @endphp
                                        @foreach (App\JournalRecordsTemp::where('master_account_id', $unique_master_ac->master_account_id )->distinct()->get('account_head_id') as $account_head_id)
                                            
                                            @php
                                                $single_dr=0;
                                                $single_cr=0;
                                            @endphp
                                            @foreach (App\JournalRecordsTemp::where('account_head_id', $account_head_id->account_head_id)->get() as $single_jl_entry)
