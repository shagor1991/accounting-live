    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="nav nav-tabs master-tab-section" id="nav-tab" role="tablist">
                ...
                <a href="{{route("new-accounts-payable-ledger")}}" class="nav-item nav-link tabPadding active" role="tab" aria-controls="nav-contact" aria-selected="false">
                    <div class="master-icon text-cente">
                    ...
                    <div class="content-body">
                        ...
                        <section id="widgets-Statistics">
                            <div class="cardStyleChage">
                                <div class="card-header d-flex pb-0 pr-2">
                                    <h4 class="card-title flex-grow-1">Accounts Payable Ledger
                                        @php
                                            if(isset($date)){
                                                echo $date;
