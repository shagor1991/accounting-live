                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <input type="text" id="pi_name" class="form-control"
                                                                        name="pi_name"
                                                                        value="{{ isset($partyInfo) ? $partyInfo->pi_name : '' }}"
                                                                    ...
                                                                    <select name="pi_type" class="form-control" id=""
                                                                        ...
                                                                        @foreach ($costTypes as $item)
                                                                            <option value="{{ $item->title }}"
                                                                                {{ isset($partyInfo) ? ($partyInfo->pi_type == $item->title ? 'selected' : '') : '' }}>
                                                                                {{ $item->title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <input type="text" id="address" class="form-control"
                                                                        name="address"
                                                                        value="{{ isset($partyInfo) ? $partyInfo->address : '' }}"
                                                                        placeholder="Address">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <input type="text" id="con_person"
                                                                        ...
                                                                        value="{{ isset($partyInfo) ? $partyInfo->con_person : '' }}"
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <input type="number" id="con_no" class="form-control"
                                                                        name="con_no"
                                                                        value="{{ isset($partyInfo) ? $partyInfo->con_no : '' }}"
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <input type="number" id="phone_no"
                                                                        ...
                                                                        value="{{ isset($partyInfo) ? $partyInfo->phone_no : '' }}"
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <input type="text" id="email" class="form-control"
                                                                        name="email"
                                                                        value="{{ isset($partyInfo) ? $partyInfo->email : '' }}"
                                                                        placeholder="Email">
                                                                ...
                                                                <div class="col-12 d-flex justify-content-end ">
                                                                    ...
                                                                    data_target="{{ route('partyInfoForm') }}"
                                                                    >New</button>
                                                                    <button type="submit"
