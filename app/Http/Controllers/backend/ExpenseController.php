...
class ExpenseController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('backend.expense.new-edit-form', compact('master_accounts', 'parties','expenses','edit_expense','account_heads'));
    ...
    public function new_expense(Request $request){
        ...
        $master_accounts=MasterAccount::all();
        $expensesPDF = Expense::latest()->get();
        $parties= PartyInfo::whereIn('pi_type', ['Supplier','Employee','Government Body'])->get();
        return view('backend.expense.new-index', compact('master_accounts', 'parties','expenses', 'expensesPDF'));
    }
}
